...
#
# Installs default plan types and built-in agent harnesses. Both installers
# create missing rows without overwriting host edits, so version bumps can add
# reference data safely. To overwrite plan types with the shipped defaults,
# run `bin/rails coplan:plan_types:install_defaults FORCE=1` explicitly.
CoPlan::PlanTypes::InstallDefaults.call
CoPlan::AgentHarness.install_built_ins!
