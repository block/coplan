...
A one-line subtitle: what this deck asks its audience to decide or take away.

---

## The headline of your first point

- Say the point in the heading, not "Background"
- Keep bullets short; the deck view is for review, the presenter is for the room

<!-- notes: Speaker notes live in comments starting with "notes" - they are
hidden from the slides and shown only to the presenter. -->
